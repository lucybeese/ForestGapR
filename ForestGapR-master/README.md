...
pplot(Gap_changes, add=TRUE, col=gap_colors[c(1,2,3)], legend=FALSE)
legend("bottom", legend=c("New Gaps", "Persistent Gaps", "Closed Gaps"),
       fill=gap_colors, horiz=FALSE, bty="n", xpd=TRUE, inset=c(0.5, 0.2))
```
